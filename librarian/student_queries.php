                                    ...
                                    <ul class="nav nav-tabs nav-overflow header-tabs">
                                        <li class="nav-item">
                                            <a href="#!" class="nav-link text-nowrap active">
                                                All Query <span class="badge rounded-pill bg-soft-secondary"><?php echo mysqli_num_rows($sres); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-hover table-nowrap card-table" id="myTable">
                                                    ...
                                                    <tbody class="list font-size-base">
                                                        <?php
                                                        $c = 1;
                                                        while ($urow = mysqli_fetch_assoc($sres)) {
                                                            $qfrom = $urow['QueryFromId'];
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <!-- Text -->
                                                                    <span class="item-title"><?php echo $stu_row['firstname'] . " " . $stu_row['lastname']; ?></span>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    $a = $urow['Querystatus'];
